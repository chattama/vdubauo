...
#define WSAPROTOCOL_INFOW_STRING_REPRESENTATION_MAX_SIZE 1500
...
#define PROCESSENTRY32W_STRING_REPRESENTATION_MAX_SIZE (260+MAX_PATH)
#define MODULEENTRY32A_STRING_REPRESENTATION_MAX_SIZE (260+MAX_PATH+MAX_MODULE_NAME32)
#define MODULEENTRY32W_STRING_REPRESENTATION_MAX_SIZE (260+MAX_PATH+MAX_MODULE_NAME32)
#define WIN32_FIND_DATAA_STRING_REPRESENTATION_MAX_SIZE 1024
#define WIN32_FIND_DATAW_STRING_REPRESENTATION_MAX_SIZE 1024
...
#define SHFILEINFOW_STRING_REPRESENTATION_MAX_SIZE 400
#define NOTIFYICONDATAA_STRING_REPRESENTATION_MAX_SIZE 400
#define NOTIFYICONDATAW_STRING_REPRESENTATION_MAX_SIZE 400
...
private:
    ...
    static void GenericParameterParsing(PARAMETER_LOG_INFOS* pParamLog,
                                        DWORD SizeOfType,
                                        BOOL IsPointer,
                                        tagParamParsingProc pfnParsingFunc,
                                        DWORD OneParamStringRepresentationSize,
                                        OUT TCHAR** ppszParam,
                                        TCHAR* FieldSplitter,
                                        BOOL DisplayTypeName,
                                        BOOL DisplayPointerValue,
                                        BOOL DisplayArrayLimits,
...
public:
    ...
    static DWORD GetParamSize(DWORD ParamType);
    static void ParameterToString(PARAMETER_LOG_INFOS* pParamLog,TCHAR** pszParameter);
    static void ParameterToString(PARAMETER_LOG_INFOS* pParamLog,TCHAR** pszParameter,DWORD NbRequieredChars);
