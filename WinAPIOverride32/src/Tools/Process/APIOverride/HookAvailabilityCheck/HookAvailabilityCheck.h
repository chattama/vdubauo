...
public:
    ...
    typedef struct tagSTRUCT_FIRST_BYTES_CAN_BE_EXECUTED_ANYWHERE_RESULT
    {
        ...
        //    The relative insturction length for relative 32 jump or call is 1 or 2 bytes length
        //
    ...
    */
    ...
    static BOOL CanFirstBytesBeExecutedAnyWhere(HANDLE hFile,DWORD FunctionRawAddress,OUT STRUCT_FIRST_BYTES_CAN_BE_EXECUTED_ANYWHERE_RESULT* pCanFirstBytesBeExecutedAnyWhereResult);
    ...
    static BOOL IsFunctionHookable(HANDLE hFile,DWORD FunctionRaw,OUT IsFunctionHookableResult* pCheckResult);
