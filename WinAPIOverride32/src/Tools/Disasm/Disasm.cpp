...
CDisasmBase::CDisasmBase()
{
    this->ResetVars();
}

CDisasmBase::~CDisasmBase(void)
{

}
void CDisasmBase::ResetVars()
{
...
void CDisasmBase::PrintByte(TCHAR** ppsz,BYTE b)
{
    _stprintf(*ppsz,_T("%.2X "),b);
    *ppsz+=3;
}

BOOL CDisasmBase::ToString(TCHAR* pszString)
{
